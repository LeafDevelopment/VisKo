	...
	<div class="form-group">
		<div class="col-lg-10">
			<label for="Email" class="control-label">Email *</label>
      			<br/>
			<input type="text" class="form-control" name ="remail" id="remail" placeholder="Email" required>
			<br/>
        		<label for="confirmEmail" class="control-label">Confirm Email *</label>
			<br/>
		        <input type="text" class="form-control" id="rCemail" name=="rCemail" placeholder="Confirm Email" required>
			<br/>
			...
			<input type="password" class="form-control" id="rpassword"name="rpassword"  placeholder="password" required>
        		...
        		<br/>
			<input type="password" class="form-control" id="rconfirmPassword" name="rconfirmPassword" placeholder="Confirm Password" required>
