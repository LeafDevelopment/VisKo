...
?>
  ...
  <?php 
		...
		echo "<b>Image </b><br/>";
		$sql =mysql_query("SELECT * FROM History WHERE user='".$_SESSION['email']."' AND image='".$_GET['image']."'");
		...
		{
			echo "<a href='viewDetails.php?id=".$row["image"]."'><img src=http://cs4311.cs.utep.edu/team2/Visualizations/".$row["image"]." style='width:750px; height:300px'></a></td>";
