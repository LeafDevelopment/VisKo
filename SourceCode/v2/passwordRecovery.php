...
?>
  ...
  <fieldset>
   ...
   <div class="form-group">
     <form role="form" name="recover" id="recover" action="passwordSent.php"  onsubmit="return (checkRequiredFields('r', 'recover') ? true : (alert('missing required field')==false))" method="post">
