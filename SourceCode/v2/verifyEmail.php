...
<?php
    ...
    $sql="INSERT INTO User (email, password, fname, lname, organization, status) VALUES ('$_POST[remail]', '$_POST[rpassword]', '$_POST[fname]', '$_POST[lname]', '$_POST[rorganization]', 'Active')";
