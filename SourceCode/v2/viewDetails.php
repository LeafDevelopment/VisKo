...
?>
  ...
  <?php 
		...
		echo "<b>Image </b><br/>";
		$sql =mysql_query("SELECT * FROM Pipeline WHERE user='".$_SESSION['email']."' AND id='".$_GET['id']."'");
		...
		{
			echo "<img src='" . $row['image'] . "' style='width:750px; height:300px'></td>";
			...
			echo "<textarea readonly rows='15' cols='97'>".$row['query']. "</textarea>";
			$count++;
		}
