...
function setfields()
{
	var query="SELECT * FROM Pipeline WHERE user='<?php echo $_SESSION['email']; ?>'";
...
<br/> <br/>
	...
	if(isset($_POST['qry']))
	{
		...
		while ($row = mysql_fetch_array($sql))
		{
			//echo "<img src='" . $row['image'] . "' alt='some_text'>";
			echo "<td><a href='viewDetails.php?id=".$row['id']."'><img src='" . $row['image'] . "' style='width:200px; height:100px'></a></td>";
			if($count % 3==0)
			{
				echo "</tr><tr>";
			}
